...
<head>
    <meta charset="utf-8" />
    <title>Arioci Carlos Amorim</title>
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    <div class="box box-content">
                        ...
                        <div class="pb-0 pb-sm-2">
                            ...
                            <p>Como muitos, comecei na programação por curiosidade, assim como o meu professor Iury!
                                estou estudando bastante, tenho pouco tempo, mas gosto muito de programar, comecei
                                aprendo no excel com visual basic, e espero um dia ser um programador em vários tipos de
                                linguagem.
                            </p>
                                    ...
                                    <div class="swiper-container js-carousel-clients">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <a href="#">
                                                    <img src="assets/img/weg.jpg" style="background-color: #FFF;"
                                                        alt="weg logo" /></a>
                                            </div>

                                            <!-- Item client -->
                                            <div class="swiper-slide">
                                                <a href="#"><img src="assets/img/oxford.jpg"
                                                        style="background-color: #FFF;" alt="IFTO Logo" /></a>
                                            </div>
                                            <!-- Item client -->
                                            <div class="swiper-slide">
                                                <a href="#"><img src="assets/img/pfiffiner.png"
                                                        style="background-color: #FFF;" alt="IFTO Logo" /></a>
                                            </div>
                                            <!-- Item client -->
                                            <div class="swiper-slide">
                                                <a href="#">
                                                    <img src="assets/img/yakult.png" style="background-color: #FFF;"
                                                        alt="IFTO Logo" /></a>
                                            </div>
